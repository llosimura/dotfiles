# Generated by Powerlevel10k configuration wizard on 2023-07-20 at 21:32 UTC.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 6447.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, slanted separators, blurred heads, slanted tails, 2 lines, disconnected,
# no frame, sparse, many icons, fluent, transient_prompt, instant_prompt=verbose.
